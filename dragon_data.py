...
QUESTION5_SPEED_LIMIT = 2.0
QUESTION5_KEY_POINT_INDICES = QUESTION4_KEY_POINT_INDICES
QUESTION5_SCALE_FACTORS = np.linspace(0.0, 1.2, 61)
QUESTION5_LAYER_STEPS = (1.0, 0.1, 0.01)
QUESTION5_LOCAL_TOL = 1e-6
